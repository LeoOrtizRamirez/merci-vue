    ...
    <div>
        <div class="p-grid">
            <div class="p-col-12">
                <div class="card">
                    <div class="title">
                        <Button v-permission="'categoria.create'" icon="pi pi-fw pi-plus"
                            class="p-button-primary p-button-sm mr-1 p-button-rounded p-button-outlined"
                            @click="this.$inertia.get(this.route('categorias.create'));" />
                        <h4>Categorias</h4>
                    </div>
...
export default {
    ...
    methods: {
        loadLazyData() {
            this.datatable.loading = true;
            this.datatableService.getData(this.route('categorias.datatable'), this.datatable.lazyParams).then(data => {
        ...
        edit(id) {
            this.$inertia.get(this.route('categorias.edit', id));
        },
        ...
        onDelete() {
            ...
            this.$inertia.delete(this.route('categorias.destroy', this.selectedModel.id), {
                onSuccess: () => {
