                    ...
                    <DataTable ref="dt" :value="datatable.data" :lazy="true" data-key="id" :paginator="true" :rows="50"
                        ...
                        <Column header="Acciones" style="width: 150px;">
                            <template #body="slotProps">
                                ...
                                <Button v-permission="'empresa.destroy'" icon="pi pi-trash"
...
export default {
    ...
    methods: {
        loadLazyData() {
            this.datatable.loading = true;
            this.datatableService.getData(this.route('empresas.datatable'), this.datatable.lazyParams).then(data => {
        ...
        onDelete() {
            ...
            this.$inertia.delete(this.route('empresas.destroy', this.selectedModel.id), {
                onSuccess: () => {
