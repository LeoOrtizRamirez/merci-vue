    ...
    <div>
        <div class="p-grid">
            <div class="p-col-12">
                <div class="card">
                    <div class="title">
                        <Button v-permission="'rol.create'" icon="pi pi-fw pi-plus"
                            class="p-button-primary p-button-sm mr-1 p-button-rounded p-button-outlined"
                            @click="this.$inertia.get(this.route('roles.create'));" />
                        <h4>Roles</h4>
                    </div>
                    ...
                    <DataTable ref="dt" :value="datatable.data" :lazy="true" data-key="id" :paginator="true" :rows="50"
                        ...
                        <Column header="Acciones" class="actions">
                            <template #body="slotProps">
                                ...
                                <Button v-permission="'rol.edit'" icon="pi pi-pencil"
                                    class="p-button-success p-button-sm mr-1 p-button-rounded p-button-outlined"
                                    @click="edit(slotProps.data.id)" />
                                <Button v-permission="'rol.destroy'" icon="pi pi-trash"
...
export default {
    ...
    methods: {
        loadLazyData() {
            this.datatable.loading = true;
            this.datatableService.getData(this.route('roles.datatable'), this.datatable.lazyParams).then(data => {
